...
//------------------------------------------------------------------------------------------
// F:/workspace/graphscad/graphscadfiles/wingblock.scad
//------------------------------------------------------------------------------------------
...
module wingblock(chord=100,length=10,tube1radius=2.6,tube2radius=1.6,verticalbarcount=7.0,thickness=0.4)
{
 ...
 {
  translate([i,0,0])cube([thickness,50,length],center=true);
 }
 function node_for_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = node_boolean4_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_for(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  for(i=[0:chord/verticalbarcount:chord])
  {
 ...
 function node_tube_outobject_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([chord/verticalbarcount*2,0.0,-length/2]);
 module node_tube_outobject(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([chord/verticalbarcount*2,0.0,-length/2]) cylinder(r=tube1radius+thickness,r1=tube1radius+thickness,h=length,$fn=(16+tube1radius+thickness*3.14116));
 }
 function node_tube_inobject_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([chord/verticalbarcount*2,0.0,-length/2]);
 module node_tube_inobject(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([chord/verticalbarcount*2,0.0,-length/2])translate([0,0,-(1)]) cylinder(r=tube1radius+thickness-(thickness),r1=tube1radius+thickness-(thickness),h=length+((1)*2),$fn=(16+tube1radius+thickness*3.14116));
 }
 function node_tube_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([chord/verticalbarcount*2,0.0,-length/2]);
 module node_tube(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([chord/verticalbarcount*2,0.0,-length/2])difference()
  {
    cylinder(r=tube1radius+thickness,r1=tube1radius+thickness,h=length,$fn=(16+tube1radius+thickness*3.14116));
   translate([0,0,-(1)]) cylinder(r=tube1radius+thickness-(thickness),r1=tube1radius+thickness-(thickness),h=length+((1)*2),$fn=(16+tube1radius+thickness*3.14116));
  }
 }
 ...
 {
  translate([i,0,0])cube([3.0,chord/verticalbarcount,length],center=true);
 }
 ...
 function node_rotate_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = onlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,0,45])*negonlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_rotate(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  multmatrix(m=onlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,0,45])*negonlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n)))node_cube(i,j,k,l,m,n);
 }
 function node_rotate0_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = onlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,0,-45])*negonlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_rotate0(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  multmatrix(m=onlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,0,-45])*negonlytranslate(node_cube_matrix(i=i,j=j,k=k,l=l,m=m,n=n)))node_cube(i,j,k,l,m,n);
 }
 function node_boolean4_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = node_rotate_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
...
/*BEGINGRAPHSCAD{
    "nodes": [
        ...
        },
        {
            ...
            "inputplugs": [
                ...
                },
                {
                    ...
                    "type": "str",
                    "name": "step",
                    "value": "chord/verticalbarcount"
                }
            ],
            "typename": "Node_for",
            "version": 1,
            "y": -35.6409023223396,
            "x": 242.93837352609813
        },
        {
            "name": "node_boolean0",
            "inputplugs": [
        ...
        },
        {
            ...
            "inputplugs": [
                ...
                },
                {
                    "type": "str",
                    "name": "tx",
                    "value": "chord/verticalbarcount*2"
                },
                {
                    "type": "str",
                    "name": "ty",
        ...
        },
        {
            ...
            "version": 1,
            "y": -127.05186892176528,
            "x": -110.23512769947979
        },
        {
            "name": "node_rotate0",
            "inputplugs": [
