...
// D:/workspace/graphscad/graphscadfiles/rocket.scad
//------------------------------------------------------------------------------------------
...
module rocket(radius=6,tickness=2,coneheight=20,bodyheight=40)
{
 ...
 {
  translate([0,0,-(0)]) cylinder(r=radius-(tickness),r1=radius-radius/4-(tickness),h=bodyheight+((0)*2),$fn=(16+radius*3.14116));
 }
