...
//------------------------------------------------------------------------------------------
// F:/workspace/graphscad/graphscadfiles/geardoublehelical.scad
//------------------------------------------------------------------------------------------
...
module geardoublehelical()
{
 ...
 module node_gear(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  union()
  {
   translate([0,0,0.5*(((20.0)*0.5))])gear(mm_per_tooth=2.0,number_of_teeth=25.0,thickness=((20.0)*0.5),hole_diameter=3,twist=(0.6),slices=32.0,teeth_to_hide=0,pressure_angle=28,clearance=0,backlash=0);
   mirror([0,0,1])
   {
    translate([0,0,0.5*(((20.0)*0.5))])gear(mm_per_tooth=2.0,number_of_teeth=25.0,thickness=((20.0)*0.5),hole_diameter=3,twist=(0.6),slices=32.0,teeth_to_hide=0,pressure_angle=28,clearance=0,backlash=0);
   }
 ...
 module node_gear0(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  union()
  {
   translate([0,0,0.5*(((14.0)*0.5))])gear(mm_per_tooth=2.0,number_of_teeth=12.0,thickness=((14.0)*0.5),hole_diameter=3,twist=(-0.6),slices=32.0,teeth_to_hide=0,pressure_angle=28,clearance=0,backlash=0);
   mirror([0,0,1])
   {
    translate([0,0,0.5*(((14.0)*0.5))])gear(mm_per_tooth=2.0,number_of_teeth=12.0,thickness=((14.0)*0.5),hole_diameter=3,twist=(-0.6),slices=32.0,teeth_to_hide=0,pressure_angle=28,clearance=0,backlash=0);
   }
 ...
 function node_translate_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([0,(((2.0)*((25.0)/ 3.1415926 / 2))),0])*node_gear_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_translate(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([0,(((2.0)*((25.0)/ 3.1415926 / 2))),0])node_gear(i,j,k,l,m,n);
 }
 function node_translate0_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = translate([0,((((2.0)*((12.0)/ 3.1415926 / 2)))*-1),0])*node_gear0_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_translate0(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  translate([0,((((2.0)*((12.0)/ 3.1415926 / 2)))*-1),0])node_gear0(i,j,k,l,m,n);
 }
 ...
 function node_rotate0_matrix(i=0,j=0,k=0,l=0,m=0,n=0) = onlytranslate(node_boolean_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,90,0])*negonlytranslate(node_boolean_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*node_boolean_matrix(i=i,j=j,k=k,l=l,m=m,n=n);
 module node_rotate0(i=0,j=0,k=0,l=0,m=0,n=0)
 {
  multmatrix(m=onlytranslate(node_boolean_matrix(i=i,j=j,k=k,l=l,m=m,n=n))*rotate([0,90,0])*negonlytranslate(node_boolean_matrix(i=i,j=j,k=k,l=l,m=m,n=n)))node_boolean(i,j,k,l,m,n);
 }
 node_rotate0();
 /*--------------------------------------------------------------------------------------------------------
    ...
    "nodes": [
        {
            ...
            "inputplugs": [
                ...
                {
                    "alias": "twist factor",
                    "tip": "twist factor from thickness",
                    "type": "str",
                    "name": "twist",
                    "value": "0.6"
                },
                {
                    "tip": "slices for twist",
                    "type": "str",
                    "name": "slices",
                    "value": "32.0"
                },
